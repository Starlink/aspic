      subroutine convr(in,nsin,ndet,sbegin,send,nsout,out,status)
*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*PURPOSE
*	Convert the input REAL data to DOUBLE PRECISION, using only
*       samples SBEGIN to SEND from each detector.
*
*SOURCE
*       CONVR.FOR in NDFOUT.TLB
*
*ARGUMENTS       
*   INPUT:
*       in(nsin,ndet) real      Input integer data.
