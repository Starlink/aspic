      subroutine convi(in,nsin,ndet,sbegin,send,nsout,out,status)
*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*PURPOSE
*	Convert the input INTEGER data to DOUBLE PRECISION, using only
*       samples SBEGIN to SEND from each detector.
*
*SOURCE
*       CONVI.FOR in NDFOUT.TLB
*
*ARGUMENTS       
*   INPUT:
*       in(nsin,ndet) integer   Input integer data.
