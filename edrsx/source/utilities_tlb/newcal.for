      subroutine newcal(trfpsk,samp,frame,crdata,band)
*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*PURPOSE
*       Calculates the 6 co-efficients of a linear transformation
*       from IRAS focal plane co-ordinates (z,y) in arcmins, to
*       trial sky image pixel co-ordinates for a given sample.
*
*SOURCE
*       NEWCAL.FOR in UTILITIES.TLB
*
*METHOD
...
*
      ...
      real*8    BS_cac(DS_mxb+4)! Constant of linear fit to clock angle
      real*8    BS_cak(DS_mxb+4)! Gradient of linear fit to clock angle
      real*8    BS_slc(DS_mxb+4)! Constant of linear fit to solar long.
      real*8    BS_slk(DS_mxb+4)! Gradient of linear fit to solar long.
      real*8    BS_thc(DS_mxb+4)! Constant sun angle value
      real*8    BS_thk(DS_mxb+4)! Constant sun angle value
...
*
      common /NBORE/ BS_cac,BS_cak,BS_slc,BS_slk,BS_thc,BS_thk
...
* AT THE GIVEN TIME USING THE CUBIC SPLINES
*
      m=DS_bsa(frame)
