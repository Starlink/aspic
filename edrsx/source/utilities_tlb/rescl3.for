      subroutine rescl3(iin,npix,nlin,bscale,bzero,blank,iout,pinval,
     :                  allrej)
*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*PURPOSE
*       To rescale the input image from signed longword format to
...
*
*SOURCE
*       RESCL3.FOR in UTILITIES.TLB
*
*ARGUMENTS
*   INPUTS:
*       iin     integer array   The input image
