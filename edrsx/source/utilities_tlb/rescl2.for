      subroutine rescl2(iin,npix,nlin,bscale,bzero,blank,iout,pinval,
     :                  allrej)
*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*PURPOSE
*       To copy values from a signed word array into another signed
*       word array, replacing FITS blank pixels by EDRS invalid pixels.
*
*SOURCE
*       RESCL2.FOR in UTILITIES.TLB
*
*ARGUMENTS
*   INPUTS:
*       iin     word array      The input image
