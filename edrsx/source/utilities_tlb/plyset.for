      ...
      subroutine plyset(ia,npixa,nlinea,x,y,nxy,fill,ierr)
 
*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*PURPOSE
*       TO SET A POLYGONAL REGION OF AN IMAGE TO A CONSTANT VALUE
*
*SOURCE
*	PLYSET.FOR in UTILITIES.TLB
*
*METHOD
...
*       POSITION ORDER. SET ALTERNATE REGIONS BETWEEN THESE INTERSECT-
*       IONS.
*
*ARGUMENTS
*       IA (IN/OUT)
...
*	FILL (IN)
*	REAL
*		THE VALUE TO USE TO FILL THE POLYGON
*       IERR (OUT)
*       INTEGER
...
*
*WRITTEN BY
*       BASED ON "PLYSMP" BY R.F. WARREN-SMITH
*-----------------------------------------------------------------------
*
*
      real ia(npixa,nlinea)
      integer limit(4)
      logical exit
      real x(nxy),y(nxy)
...
*
* SET PIXELS LYING BETWEEN EACH PAIR OF INTERSECTIONS 
*
