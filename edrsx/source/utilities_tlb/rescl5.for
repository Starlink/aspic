      subroutine rescl5(iin,npix,nlin,bscale,bzero,blank,iout,pinval,
     :                  allrej)
*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*PURPOSE
*       To rescale the input image from double precision format to
...
*
*SOURCE
*       RESCL5.FOR in UTILITIES.TLB
*
*ARGUMENTS
*   INPUTS:
*       iin     dble array      The input image
