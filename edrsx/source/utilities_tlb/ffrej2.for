      subroutine ffrej2(ia,npix,nlines,rinval,niter,gamma,ix1,iy1,ix2,
     :  iy2,ilevel,scale,sigma,convrg,out,ngood,rstor,nstor,rline,nline)
...
*
*SOURCE
*	FFREJ2.FOR in UTILITIES.TLB
*
*METHOD
*	LIKE FFREJ EXCEPT USES REAL DATA ARRAYS INSTEAD OF INTEGER.
*
