      subroutine rltoi4(iout,rin,npix,nlin,inval,rinval,scale,zero)
*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*PURPOSE
*       To copy a real image to an integer*4 image scaling the data
*       values at the same time.
*
*SOURCE
*       RLTOI4.FOR in UTILITIES.TLB
*
*METHOD
...
*                               real to integer data representation
*   OUTPUTS:
*       iout(npix,nlin) integer The output integer*4 image
*
*USED BY
*       SIMCRDD
*
