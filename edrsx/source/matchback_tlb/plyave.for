      subroutine plyave(ia,npixa,nlinea,scale,zero,invala,x,y,nxy,ave,
     :                  ierr)
*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*PURPOSE
*       To calculate the average of all pixel values within a given 
*	polygon
*
*SOURCE
*	PLYAVE.FOR in MATCHBACK.TLB
*
*METHOD
...
*
                  do 60 i=minx,maxx
                     ...
                     if(i.le.npixa.and.j.le.nlinea) then
                        ...
                        if(ival.ne.invala) then
                           sum1=sum1+(ival*scale+zero)
                           nval=nval+1
                        endif
                     endif
