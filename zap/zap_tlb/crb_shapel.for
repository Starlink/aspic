      SUBROUTINE CRB_SHAPEL(AXMAJOR,ECCEN,THETA,ICX,ICY,COLCURS)
*+
*   SHAPEL
*
...
*  to convert initial cursor position and AXMAJOR from pixel coords to a
...
*
     ...
     :                   LABEL3(FUNC+1),LABEL4)
         ...
         CALL ARGS_USRCUR(8,COLCURS,CURSOR,XIN,YIN,XOUT,YOUT,BUTT)
         XIN=XOUT
         YIN=YOUT
      ENDDO
...
*
*  now have returned args (ix,iy) in args coords. to convert to pixel co
