*
*+ SUB  IMAGEIN1  IMAGEIN2  IMAGEOUT
*
*  THE DIFERENCE IMAGEIN1-IMAGEIN2 IS STORED IN IMAGEOUT
*
      ...
      CALL SUB(NELS,%VAL(IPIN1),%VAL(IPIN2),%VAL(IPOUT))
      GO TO 9999
