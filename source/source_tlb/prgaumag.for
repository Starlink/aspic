...
C
C          FUNCTION:-
C               It reads the output of GAUMAG and types out a convenient
...
*  PURPOSE
*        To type and make a .LIS file of the GAUMAG output file.
*
*  METHOD
...
C
     ...
     +                       ARMS,ITER,NINVAL,BASE,RX,RY
  910    FORMAT (1H ,I5,F7.2,F8.1,2F6.1,F6.1,I3,I5,F7.1,2F6.2)
         CALL WRUSER(PRBUF,ISTAT)
      ENDIF
C
