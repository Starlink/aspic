...
*
      integer   lens  ! A function giving used length of a string
...
*
      ...
      call agsetc('LINE/TEXT.',xtitle(:lens(xtitle))//'$')
*
...
*
      ...
      call agseti('LINE/NUMBER.',100)
      call agsetf('LINE/CHARACTER.',0.022)
      call agsetc('LINE/TEXT.',ytitle(:lens(ytitle))//'$')
*
...
*
      ...
      y(2)=ymax
      call agseti('SET.',-1)
      call ezxy(x,y,2,title(:lens(title))//'$')
*
* FINISH
*
      end
